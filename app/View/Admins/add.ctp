...
<script type="text/javascript">
    ...
    function selectFile(filename) {
        ...
        document.getElementById(currentCardID).innerHTML = '<i class="mdi-content-clear right" onclick="clearImage(\''+currentCardID+'\')"></i><img class=\"responsive-img\" name=\"'+filename+'\" src=\"/mnemosyne/app/webroot/files/'+fileurl+'\">';
    }
